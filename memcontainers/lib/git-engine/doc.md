...
| `:libgit_engine` | Shared library packaging (PR7d; Port remains primary) |
...
No gojs. No freestanding product path. Remotes are host-mediated (TS orch on JS, C orch on server).
