//! Link-time descriptor for the first captured-upvalue strict-AOT program.
//!
//! The backend object owns executable functions; this shared module owns the immutable metadata
//! used by the differential oracle to publish those functions as real Luau Protos.
...
pub const source_name = "=aot/captured_call.luau";
