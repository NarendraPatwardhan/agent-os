//! Link-time descriptor for the first fixed multi-result strict-AOT program.
//!
//! The exact source has a closed three-Proto graph. Its inner function returns two contiguous
//! TValues, and its caller consumes both after a fixed two-argument/two-result compiled call.
...
pub const source_name = "=aot/multi_result_call.luau";
