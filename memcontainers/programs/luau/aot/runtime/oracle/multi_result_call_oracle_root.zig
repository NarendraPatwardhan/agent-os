...
export fn mc_luau_aot_v1_multi_result_call_oracle_init() void {
    if (initialized)
        return;
    initialized = true;
    __wasm_call_ctors();
...
// The root returns the compiled caller Closure. The caller materializes its closed child, requests
// two results, consumes both after the call, and returns one numeric result to this API.
export fn mc_luau_aot_v1_multi_result_call_oracle_run(lhs: i32, rhs: i32) i32 {
