...
const GROUPS: ReadonlyArray<Readonly<{ title: string; pages: ReadonlyArray<PageDefinition> }>> = [
  {
    ...
    pages: [
      ...
      ["installation", "Installation and imports", "Packages, release artifacts, imports, and a first VM."],
  ...
  },
  {
    ...
    pages: [
      ["snapshots", "Snapshots, restore, and fork", "Full and incremental state, portability, and branching."],
      ["images-stores", "Images and content stores", "Layers, manifests, storage backends, and ownership."],
      ["llb", "LLB", "Build graphs, solving, cache rules, and definition transport."],
      ["recording-remote-build", "Recording and remote builds", "Turn live work into build graphs and solve remotely."],
    ],
  },
  {
    title: "Browser and advanced",
    pages: [
      ["browser-elements", "Browser elements", "Custom elements, artifact loading, events, and styling."],
      ["advanced-api", "Advanced API", "Backends, sinks, loaders, and integration-level exports."],
      ["errors", "Errors and diagnostics", "Thrown errors, exit status, policy denials, and cleanup."],
      ["symbol-index", "Symbol index", "Alphabetical lookup across every JavaScript runtime export."],
    ],
  },
];
