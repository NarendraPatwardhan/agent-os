...
export const font = stylex.defineVars({
  ...
  display:
    '"Inter Tight Variable", "Inter Tight", "InterVariable", "Inter Variable", "Inter", ui-sans-serif, system-ui, sans-serif',
  mono: '"IBM Plex Mono", "Geist Mono Variable", "Geist Mono", ui-monospace, "SF Mono", Menlo, monospace',
  serif:
    '"Newsreader", "Newsreader Variable", "Source Serif 4", "Iowan Old Style", Charter, Georgia, serif',
});
