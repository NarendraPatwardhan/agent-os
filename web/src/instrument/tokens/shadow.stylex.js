...
export const shadow = stylex.defineVars({
  ...
  raised:
    "0 2px 4px -2px light-dark(oklch(0 0 0 / 0.06), oklch(0 0 0 / 0.40)), 0 4px 12px -4px light-dark(oklch(0 0 0 / 0.08), oklch(0 0 0 / 0.45))",
  overlay:
    "0 3px 12px -4px light-dark(oklch(0 0 0 / 0.10), oklch(0 0 0 / 0.50)), 0 12px 32px -12px light-dark(oklch(0 0 0 / 0.14), oklch(0 0 0 / 0.55))",
  modal:
    "0 12px 32px -12px light-dark(oklch(0 0 0 / 0.18), oklch(0 0 0 / 0.60)), 0 40px 96px -32px light-dark(oklch(0 0 0 / 0.24), oklch(0 0 0 / 0.70))",
  toast:
    "0 8px 24px -8px light-dark(oklch(0 0 0 / 0.20), oklch(0 0 0 / 0.60)), 0 24px 48px -24px light-dark(oklch(0 0 0 / 0.28), oklch(0 0 0 / 0.70))",
});
