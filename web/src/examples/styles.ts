...
export const styles = stylex.create({
  ...
  area: {
    ...
    paddingTop: {
      default: "clamp(24px, 3vh, 44px)",
      [media.tablet]: space.s6,
      [media.mobile]: space.s5,
    },
    paddingBottom: {
      default: "clamp(24px, 3vh, 44px)",
      [media.tablet]: space.s6,
    ...
    paddingLeft: {
      default: "clamp(56px, 5vw, 72px)",
      [media.tablet]: space.s6,
      [media.mobile]: space.s4,
    },
    paddingRight: {
      default: "clamp(24px, 4vw, 80px)",
      [media.tablet]: space.s6,
      [media.mobile]: space.s4,
    },
    borderTopWidth: "1px",
  ...
  tocCol: {
    alignSelf: { default: "center", [media.tablet]: "stretch", [media.mobile]: "stretch" },
    minHeight: 0,
    minWidth: 0,
  },
  main: {
  ...
  terminalBox: {
    width: "100%",
    height: {
      default: "clamp(220px, 42vh, 460px)",
      [media.tablet]: "clamp(280px, 42vh, 420px)",
      [media.mobile]: "320px",
    },
    flexShrink: 0,
    borderRadius: radius.card,
