...
| `vm.browsers` | `VmBrowsers`      | Typed browser-sidecar lifecycle, pages, and input |
...
`vm.browsers` layers the generated browser contract over that lifecycle; see
[Browser sidecars](./browser-sidecars.md).
