...
import { mc, MemoryContentStore, type Vm } from "../../lib/sdk.js";
import { parseArgs, ResultBuilder, type Profile } from "../../lib/result.js";
import { monotonicMs, sha256, systemMetadata } from "../../lib/system.js";
...
async function main(): Promise<void> {
  ...
  const result = new ResultBuilder({
    ...
    runner: "benchmarks/runners/embedded/runner",
