defmodule AgentOS.Sidecars.Firecracker.BrowserTest do
  ...
  test "real browser runner boots and executes its projected page protocol" do
    ...
    assert {:ok, daemon} = AgentOS.Sidecars.Firecracker.Machine.measurements(instance.id)
    assert {:ok, relay} = AgentOS.Sidecars.Firecracker.RunnerConnection.measurements(instance.id)
