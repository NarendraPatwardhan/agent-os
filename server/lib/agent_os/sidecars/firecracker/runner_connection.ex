defmodule AgentOS.Sidecars.Firecracker.RunnerConnection do
  @moduledoc false
  ...
  def init(opts) do
    ...
    with {:ok, path} <- AgentOS.Sidecars.Firecracker.Machine.socket(id),
  ...
  defp diagnostics(id) do
    AgentOS.Sidecars.Firecracker.Machine.diagnostics(id)
  catch
    :exit, _reason -> <<>>
  end
